...
- 本地确定性站点已覆盖 redirect、空结果、字段/JSON 异常、429/403/404/5xx、慢响应/超时、响应超限、robots 拒绝、Browser POST/popup/download/跨源导航、selector 缺失以及 Recipe 声明的登录过期/验证码信号；仍需补 Artifact provider 断连与 Browser crash 的组合进程切点；
