...
func htmlListingSpec() recipeabi.Spec {
	return recipeabi.Spec{
		...
		Listing: &recipeabi.ListingContract{IdentityField: "job_key", ActivityField: "activity_at", BoundaryMode: "activity_time",
			Ordering: "newest_activity_desc", UpdateRetop: true, OverlapPages: 2, MaxPages: 100, MaxItemsPerPage: 100, ExcludePinnedField: "pinned"},
	}
}

func TestExecuteHTMLUsesScopedSelectorsAttributesAndText(t *testing.T) {
	document := []byte(`<!doctype html><html><body>
      <article class="job"><a class="role" data-job-id="ad"><span class="title">Pinned Role</span></a><time datetime="2026-09-08T11:00:00Z"></time><i class="pin" data-pinned="true"></i></article>
